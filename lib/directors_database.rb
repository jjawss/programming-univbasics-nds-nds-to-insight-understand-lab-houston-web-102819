...
#AoH - EVERYTHING contained in ARRAY (ROW_INDEX)
  #HASH specific to the director contains 2 hashes:
  # -HASH Director name
  # -HASH movies contains 
    # -Inner Array of hashes (COLUMN_INDEX) = All titles contained in array
      #Hash containing info on each movie
        # title
        # studio
        # Worldwide_gross
        # Release Year
